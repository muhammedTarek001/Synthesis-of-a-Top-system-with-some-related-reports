...
#I/P CONSTRAINS
set_input_delay $input1_delay -clock $CLK_NAME [get_ports CLKDIV_EN]  ## aside get_ports we write the clk name in rtl file and aside -clock we write clk name we defined ##
